...
class _BookingDetailScreenState extends State<BookingDetailScreen>
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                     Text(
  bookingDetail.bookingsType == "instance"
      ? "Instant Wash"
      : bookingDetail.bookingsType == "daily"
          ? "Daily Wash"
          : bookingDetail.bookingsType.validate().isNotEmpty
  ...
  overflow: TextOverflow.ellipsis,
                  ...
                  const SizedBox(height: 8),
                  Text(bookingDetail.bookingAt == "home"
                  ? "At Home"
                  : bookingDetail.bookingAt == "shed"
                      ? "At Shed"
                      : "At Home", maxLines: 1, overflow: TextOverflow.ellipsis),
                  const SizedBox(height: 8),
                  Text(bookingDetail.plan != null
                  ? "${bookingDetail.plan!.name} ₹${bookingDetail.plan!.amount}"
                  : "No Plan",
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis),
                  ],
                ...
                ClipRRect(
                  ...
                  child: CachedImageWidget(
                    url: serviceDetail.attachments != null &&
                            serviceDetail.attachments!.isNotEmpty
                        ...
                        : bookingDetail.bookingPackage != null &&
                            ...
                            ? bookingDetail.bookingPackage!.imageAttachments
                                ...
                                .first
                                .validate()
                            : bookingDetail.serviceAttachments != null &&
                                    bookingDetail.serviceAttachments!.isNotEmpty
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          snap.data!.service!.name
                              .validate(), // or serviceName depending on your model
                          style: TextStyle(
                      ...
                      if (snap.data!.bookingDetail!.extraVehicles
                        ...
                        Column(
                          children: snap.data!.bookingDetail!.extraVehicles
                              ...
                              .map((vehicle) {
                            return _vehicleCard(
                              imageUrl: vehicle.serviceImages?.first,
                              vehicle: vehicle.serviceName ?? "N/A",
                              planName: vehicle.planName ?? "N/A",
