...
class ServiceData {
  ...
  List<Attachments>? galleryImagesArray;
...
List<ServicePlanData>? plans;
  ...
  factory ServiceData.fromJson(Map<String, dynamic> json) {
    return ServiceData(
      ...
      galleryImages: json['gallery_images'] != null
          ...
          : null,
      galleryImagesArray: json['gallery_images_array'] != null
          ? (json['gallery_images_array'] as List)
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.galleryImagesArray != null) {
      data['gallery_images_array'] =
          this.galleryImagesArray!.map((v) => v.toJson()).toList();
    }
